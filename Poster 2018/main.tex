...
\begin{column}{\onecolwidth}
 ...
 \begin{block}{Landmarks}
 	...
 	\Put(1450,0){\hspace{1cm}{\LARGE{\textcolor{labriTopRed}{\textbf{How to locate the landmarks automatically}?}}}}
  	\Put(1000,7){\includegraphics[scale=.38]{images/mlandmarksline}}
...
\begin{figure}[h]
\centering
\subfloat[Left mandible]{\label{figrbox2}\includegraphics[scale=0.29,valign=m]{./images/mg19_sp}}~~
\subfloat[Right mandible]{\label{figrbox1}\includegraphics[scale=0.30,valign=m]{./images/md28_sp}}
